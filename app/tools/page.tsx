  ...
  <h1 className="text-5xl mb-2 leading-tight font-[family-name:var(--font-gt-planar-heading)] pl-[10px]">
    ...
    <p
      ...
      <img src="/assets/tools.png" className='mb-8 w-full h-52 object-cover' />
        ...
        <Picks events={[
          { id: 1, title: "Healthy Digital Habits That Protect Against Identity Theft",text:"Behavioral shifts preventing exposure without specialized tools.", tag: "#tools, , #web2, #habits",href:'https://enthec.com/en/9-healthy-digital-habits-that-will-protect-you-from-identity-theft-and-leaks' },
          ...
          { id: 3, title: "Maintain Privacy and Digital Wellness", text: "University of Washington guide on personal data management. ", tag: "#tools, , #web2, #education", href: 'https://azbigmedia.com/lifestyle/protecting-your-privacy-online-18-tips-and-resources/' },
          { id: 4, title: "Protecting Your Privacy in the Digital Age", text: "ACLU guide on legal rights and practical steps. ", tag: "#tools,  #web2, #rights", href: 'https://www.aclum.org/en/resource-protecting-your-privacy-digital-age' },
