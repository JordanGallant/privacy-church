...
export default function ManifestoPage() {
  return (
    ...
    <p
        ...
        <p className="text-base  md:text-lg leading-relaxed font-[family-name:var(--font-dm-mono)]">Because freedom needs space. </p>
        <br></br>
        ...
        <br/>
        <br/>
        <p >Because care starts with consent.</p>
        <br/>
